...
- 대상 저장소: `<repo_root>`
- 실행 루트: `<repo_root>`
- 핵심 스펙: `<repo_root>/specs/features/FEAT-1001-workflow-skill-manager-cli`
- 스킬 소스: `<repo_root>/agent/skills`
- 스킬 설치 경로: `<repo_root>/.agents/skills`
...
### 5.1 스킬 설치
1. 로컬 스킬 동기화
   - `rsync -a --delete <repo_root>/agent/skills/ <repo_root>/.agents/skills/`
2. 필수 스킬 존재 확인
...
2. 산출물 확인
   ...
   - `specs/features/FEAT-1001-workflow-skill-manager-cli/tasks.md`
...
2. YAML 파싱 확인
   ...
   - `tasks.md`은 마크다운이므로 YAML 파싱 점검 대상에서 제외하고 텍스트 유효성만 확인
