...
[Describe the problem, the operator or user, and the important boundary this spec does not cross.]
...
### 18.3 Operational Validation Before Release

- [Manual or end-to-end validation that must be completed before release or handoff]

### 18.4 Spec Update Triggers
