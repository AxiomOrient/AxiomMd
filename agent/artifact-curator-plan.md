...
skills/artifact-curator/
  ...
  scripts/
    check_cleanup_request.rb      # 입력 유효성 검사
```

**AxiomMd**

```
docs/13_MAINTENANCE_WORKFLOW.md   # 유지보수 워크플로우 정의
```
...
4. `SKILL.md`
5. `check_cleanup_request.rb`
6. `agents/openai.yaml`
7. `docs/13_MAINTENANCE_WORKFLOW.md`
